...
- Migration-upgrade evidence: historical `001_tenant_school` is preserved as legacy-unverified; fixture now removes pre-run 002/audit artifacts so ordered `002_audit_immutability` is newly applied and asserted; CI re-run remains required.
