...
- Migration-upgrade evidence: historical `001_tenant_school` is preserved as legacy-unverified and ordered `002_audit_immutability` applies the append-only audit trigger; CI `32813686892` exposed a bootstrap-checksum fixture conflict, now corrected for re-run.
