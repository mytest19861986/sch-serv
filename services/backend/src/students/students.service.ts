...
export class StudentsService {
  ...
  async create(context: StudentsAuthorizationContext, body: unknown) {
    ...
    if (!school || school.status !== 'active' || school.tenantStatus !== 'active') throw new NotFoundException();
